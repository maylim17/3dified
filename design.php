...
include("inc/header.php"); ?>
		...
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href=<?php echo "'collection.php?collection=$collectionname'"; ?>><font color="#9d9f4e"><b><?php echo "$collectionname"; ?></b></font></a> &gt; <?php echo $product["title"]; ?></div>
